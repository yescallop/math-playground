...
\begin{proof}
    ...
    By Fenchel's theorem (generalized to any closed curve by Milner
    \cite[Theorem 3.4]{milner}), we know that $P$ is convex.
    A convex polygon whose edges are not all collinear is simple (why?).
\end{proof}
