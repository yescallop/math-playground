...
\begin{abstract}
    ...
    famous problem of the random walk. In this article, we present a novel problem
    (possibly a combinatorial optimization problem)
    in the spirit of Pearson's one,
...
Now, help the dog to choose $n$ cards that maximize the probability
...
because without loss of generality we might restrict step vectors
...
a simple closed form (see Conjecture \ref{con:value_formula}).
...
\begin{thebibliography}{9}
    ...
    \bibitem{ye}
    S. Ye,
    \emph{Nonlinear convex closed curves are simple},
    preprint.
