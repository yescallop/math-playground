...
\begin{abstract}
    A convex curve is, informally, a plane curve whose intersection with a
    line is either a set of at most two points or a line segment.
    With analytical definitions we show that a convex closed curve is simple
...
Now that we have checked the equivalency of definitions,
